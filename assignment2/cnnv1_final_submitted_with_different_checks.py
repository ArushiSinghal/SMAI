...
for k in range(len(batch_data_list)):
	...
	#model.fit(data, Y_train,batch_size=2000, epochs=20, verbose=1, validation_split=0.1)
	#model.fit(data, Y_train,batch_size=2000, epochs=20, validation_split=0.1)
	model.fit_generator(train_generator, steps_per_epoch=10000//64, epochs=12, validation_data=test_generator, validation_steps=1000//64)
	#model.fit_generator(train_generator, steps_per_epoch=4000//64, epochs=1, validation_data=test_generator, validation_steps=10000//64, verbose=0)
