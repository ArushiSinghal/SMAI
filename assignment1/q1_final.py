...
count, count1,count2,count3 = batch_margin_test_dataset(batch_margin_w, result1,num_cols1, num_rows1, b)
total1 = count + count2
precision3 = (count * 1.0)/total1
total2 = count + count3
recall3 = (count * 1.0)/total2

print ("%f %f" %(precision, recall))
print ("%f %f" %(precision1, recall1))
print ("%f %f" %(precision2, recall2))
print ("%f %f" %(precision3, recall3))
